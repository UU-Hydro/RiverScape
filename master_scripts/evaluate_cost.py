...
if __name__ == '__main__':
    ...
    ref_map_dir = os.path.join(root_dir, r'input\reference_maps')
    msr_map_dir = os.path.join(root_dir, r'output\waal_XL\measures_ensemble01\maps')
    input_dir = os.path.join(root_dir, 'input')
    cost_dir = os.path.join(root_dir, r'input\cost')
